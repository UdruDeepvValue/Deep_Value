...
class Purchase(ResourceMixin, db.Model):
    ...
    vat_n = db.Column(db.String(256))
    sdi = db.Column(db.String(256))
    name_card = db.Column(db.String(256))
    product = db.Column(db.String(128), index=True)
    ...
    cc_brand = db.Column(db.String(32))
    last4 = db.Column(db.String(4))
    exp_date = db.Column(db.String(32), index=True)
    invoice_sent = db.Column(db.Boolean, default=False, nullable=False)
...
class Invoice(ResourceMixin, db.Model):
    ...
    def create2(
        ...
        invoice = PaymentInvoice.create(customer_id=customer_id,
                                        amount=amount,
                                        currency=currency)
