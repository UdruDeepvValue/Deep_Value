...
from snakeeyes.blueprints.billing.forms import PaymentForm
from snakeeyes.blueprints.billing.forms import SubscriptionForm
from snakeeyes.blueprints.billing.forms import UpdateSubscriptionForm
    ...
    if form.validate_on_submit():
        ...
        if bundle is not None:
            ...
            if created:
                flash(
                    _(
                        "%(amount)s coins have been added to your account.",
