...
class TestBilling(ViewTestMixin):
    ...
    def test_pricing_page_as_subscriber(self, subscriptions):
        ...
        response = self.client.get(
            url_for("billing.pricing"), follow_redirects=True
        )
    ...
    def test_coupon_code_not_valid(self):
        ...
        response = self.client.post(
            url_for("billing.coupon_code"), data=params, follow_redirects=True
        )
    ...
    def test_subscription_create_page(self):
        ...
        response = self.client.get(
            url_for("billing.create"), follow_redirects=True
        )
    ...
    def test_subscription_create_as_subscriber(self, subscriptions):
        ...
        assert_status_with_message(
            200, response, "You already have an active subscription."
        )
    ...
    def test_subscription_create(self, users, mock_stripe):
        ...
        response = self.client.post(
            url_for("billing.create"), data=params, follow_redirects=True
        )

        assert_status_with_message(
            200, response, "You must enable JavaScript" " for this request."
        )
    ...
    def test_subscription_update_page_without_subscription(self):
        ...
        response = self.client.get(
            url_for("billing.update"), follow_redirects=True
        )
    ...
    def test_subscription_update(self, subscriptions, mock_stripe):
        ...
        response = self.client.post(
            url_for("billing.update"), data=params, follow_redirects=True
        )
    ...
    def test_subscription_cancel_page_without_subscription(self):
        ...
        response = self.client.get(
            url_for("billing.cancel"), follow_redirects=True
        )

        assert_status_with_message(
            200, response, "You do not have an active subscription."
        )
    ...
    def test_subscription_cancel(self, subscriptions, mock_stripe):
        ...
        response = self.client.post(
            url_for("billing.cancel"), data={}, follow_redirects=True
        )
    ...
    def test_subscription_update_payment_method_without_card(self):
        ...
        self.login()
        response = self.client.post(
            url_for("billing.update_payment_method"),
            data={},
    ...
    def test_subscription_update_payment_method(
        self, subscriptions, mock_stripe
    ):
